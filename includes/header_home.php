                ...
                <div class="row">
                    ...
                    <div class="col-4">
                         <div class="form-search">
                            <form class="position-relative my-2 my-lg-0" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                              <input class="form-control  mr-sm-2" type="search" placeholder="بحث" aria-label="Search" name="search">
                              <button class="btn btn-danger position-absolute my-2 my-sm-0" type="submit" title="بحث"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                    </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item p3" href="?city=<?php echo $city[0] ;?>"><?php echo $city[0] ;?></a>
